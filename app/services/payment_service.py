...
DEFAULT_PLAN_CATALOG = [
    ...
    },
    {
        ...
        "durationDays": 30,
        "selfServe": True,
        "description": "Up to 10 employees with visitor management, reception dashboard, QR check-in, directory, history, and email notifications.",
        "enabledFeatures": [
            "visitor_management",
            "reception_dashboard",
            "qr_visitor_check_in",
    ...
    },
    {
        ...
        "durationDays": 30,
        "selfServe": True,
        "description": "Up to 25 employees with visitor scheduling, host approval, delivery management, attendance, badges, and reports.",
        "enabledFeatures": [
            "visitor_management",
            "reception_dashboard",
            "qr_visitor_check_in",
    ...
    },
    {
        ...
        "durationDays": 30,
        "selfServe": True,
        "description": "Up to 50 employees with multiple receptionists, departments, role permissions, alerts, meeting visitors, and advanced reporting.",
        "enabledFeatures": [
            "visitor_management",
            "reception_dashboard",
            "qr_visitor_check_in",
    ...
    },
    {
        ...
        "durationDays": 30,
        "selfServe": True,
        "description": "Up to 100 employees with multiple branches, multi-admin, analytics, audit logs, priority support, and export reports.",
        "enabledFeatures": [
            "visitor_management",
            "reception_dashboard",
            "qr_visitor_check_in",
        ...
        "restrictions": ["api_access", "sso", "sla_support"],
    },
    {
        ...
        "selfServe": False,
        "manualActivationRequired": True,
        "description": "Unlimited employees and branches with API access, SSO, dedicated account management, branding, integrations, and SLA support.",
        "enabledFeatures": [
            "visitor_management",
            "reception_dashboard",
            "qr_visitor_check_in",
