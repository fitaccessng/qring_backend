...
class Estate(Base):
    ...
    security_can_approve_without_resident: Mapped[bool] = mapped_column(Boolean, default=False)
    security_must_notify_resident: Mapped[bool] = mapped_column(Boolean, default=True)
