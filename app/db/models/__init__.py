...
_MODEL_MODULES = (
    ...
    "app.db.models.estate_operations",
    "app.db.models.homeowner_setting",
    "app.db.models.maintenance_audit",
    "app.db.models.office_chat",
    "app.db.models.office",
    "app.db.models.office_department",
...
_EXPORT_MAP = {
    ...
    "EstatePackage": "app.db.models.estate_operations",
    "GuardAttendance": "app.db.models.estate_operations",
    "ResidentVehicle": "app.db.models.estate_operations",
    "SecurityIncident": "app.db.models.estate_operations",
    "VisitorBlocklistEntry": "app.db.models.estate_operations",
    ...
    "Office": "app.db.models.office",
    "OfficeAttendanceLog": "app.db.models.office",
    "OfficeDepartment": "app.db.models.office_department",
    "OfficeMember": "app.db.models.office",
    "OfficeStaffConversation": "app.db.models.office_chat",
    "OfficeStaffMessage": "app.db.models.office_chat",
