...
class PanicEvent(Base):
    ...
    audio_room_name: Mapped[Optional[str]] = mapped_column(String(180), nullable=True, index=True)
    audio_started_by_user_id: Mapped[Optional[str]] = mapped_column(String(36), ForeignKey("users.id"), nullable=True, index=True)
    audio_started_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
    audio_ended_at: Mapped[Optional[datetime]] = mapped_column(DateTime, nullable=True)
