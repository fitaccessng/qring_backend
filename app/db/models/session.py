...
class VisitorSession(Base):
    ...
    requested_staff_name: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    assigned_staff_user_id: Mapped[Optional[str]] = mapped_column(String(36), ForeignKey("users.id"), nullable=True, index=True)
    assigned_staff_name: Mapped[Optional[str]] = mapped_column(String(160), nullable=True)
    assigned_staff_department: Mapped[Optional[str]] = mapped_column(String(120), nullable=True)
